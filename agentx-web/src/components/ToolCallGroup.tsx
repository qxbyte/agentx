  ...
  return (
    <div>
      ...
      >
        ...
        <span className="truncate font-mono text-xs text-foreground/80">{call.name}</span>
...
/**
 * 工具调用集合：少量平铺紧凑行；多个默认收起为摘要条
 * （总数 + 最近 2 个灰字 + 隐藏数），展开为单一整体块内的紧凑行列表。
 */
