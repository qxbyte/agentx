...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between gap-2 rounded-full border border-input bg-background px-3.5 py-1 text-sm transition-colors data-[placeholder]:text-muted-foreground focus:outline-none focus:border-[var(--ax-border-strong)] disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
